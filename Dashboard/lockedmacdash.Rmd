...
ggplot(data = percent_df,
  ...
  geom_col() +
    geom_text(aes(label = paste(round(percs,2),"%")),vjust = -.3)+
    labs(title = 'Percentage of Hospitalization Groups Diagnosed with SSTVIs or Endocarditis',
       ...
       y = 'Percentage of Group with SSTVIs or Endo',
...
ggplot(data = percent_df2,
  ...
  geom_col() +
    geom_text(aes(label = paste(round(percs2,2),"%")),vjust = -.3)+
    labs(title = 'Percentage of Hospitalization Groups Diagnosed with Endocarditis',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       y = 'Percentage of Group with Endo',
       x = 'Hospitalization Group') +
  scale_fill_manual(values = c('#91BAA7', '#1B365D')) +
  theme(legend.position = '0')
...
ggplot(data = percent_df,
  ...
  geom_col() +
    geom_text(aes(label = paste(round(percs3,2),"%")),vjust = -.3)+
    labs(title = 'Percentage of Hospitalization Groups Diagnosed with Ostomyelitis',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       y = 'Percentage of Group with Endo',
       x = 'Hospitalization Group') +
...
ggplot(data = percent_df4,
  ...
  geom_col() +
    geom_text(aes(label = paste(round(percs4,2),"%")),vjust = -.3)+
...
ggplot(data = percent_df5,
  ...
  geom_col() +
    geom_text(aes(label = paste(round(percs5,2),"%")),vjust = -.3)+
...
Important Visuals {data-orientation=rows}
=======================================
...
c1<-ggplot(df1(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total3*100, 2),"%")),vjust = -.3)+
...
c2<-ggplot(df1b(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total4*100, 2),"%")), vjust = -.3)+
...
#Plots SUDS and endo
  b1<-ggplot(df2(),
      aes(x = Age_Groups,
          ...
          fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total5*100, 2),"%")), vjust = -.3)+
  ...
  #Plots SUDS and osteo
    b2<-ggplot(data = df2b(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total6*100, 2),"%")), vjust = -.3)+
  labs(title = 'Trends in Hospitalization for Endocarditis',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       x = 'Yearly Quarter',
       y = 'Total Patients') +
  ...
  total8<-md_phi_jacob%>% filter(ost) %>% nrow()
    ...
    b3<-ggplot(data = df3(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total7*100, 2),"%")), vjust = -.3)+
  ...
  theme(legend.position = "none")
      ...
      b4<-ggplot(data = df3b(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total8*100, 2),"%")), vjust = -.3)+
  labs(title = 'Trends in Hospitalization for Ostemyelitis',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       x = 'Yearly Quarter',
       y = 'Total Patients') +
...
b5<-ggplot(data = df4(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total9*100, 2),"%")), vjust = -.3)+
...
b6<-ggplot(data = df4b(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total10*100, 2),"%")), vjust = -.3)+
  labs(title = 'Trends in Hospitalization for Sepsis',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       x = 'Yearly Quarter',
       y = 'Total Patients') +
...
b7<-ggplot(data = df5(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total12*100, 2),"%")), vjust = -.3)+
...
b8<-ggplot(data = df5b(),
       aes(x = Age_Groups,
           ...
           fill = Age_Groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(n/total13*100, 2),"%")), vjust = -.3)+
  labs(title = 'Trends in Hospitalization for all SSTVIs',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       x = 'Yearly Quarter',
       y = 'Total Patients') +
...
a1<-ggplotly(ggplot(data = percent_df6,
       aes(x = groups, y = percs5, fill = groups)) +
  geom_col() +
    geom_text(aes(label = paste(round(percs6,2),"%")),vjust = -.3)+
    labs(title = 'Percentage of Money by Primary Payer with SUD',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       y = 'Percentage of Money',
       x = 'Primary Payer') +
  scale_fill_manual(values = c('#91BAA7', '#1B365D')) +
  theme(legend.position = '0'))
...
a3<-ggplotly(ggplot(data = percent_df7,
  ...
  geom_col() +
    geom_text(aes(label = paste(round(percs7,2),"%")),vjust = -.3)+
    labs(title = 'Percentage of Money by Primary Payer',
       subtitle = 'TN Hospitals 2019 | Inpatient and Outpatient',
       caption = 'End the Syndemic | DataLab 2022',
       y = 'Percentage of Money',
       x = 'Primary Payer') +
...
top<-subplot(style(a1, showlegend=F),style(a3, showlegend=F))

subplot(a2,top, nrows = 2)
```
...
infection<-c("Endo","Endo","Ost","Ost","Sepsis","Sepsis","SSTVI","SSTVI")
...
ggplot(data = percent_df8,
  ...
  geom_col(position = "dodge") +
    geom_text(aes(label = paste(round(percents,2),"%")),vjust = -.3, position = position_dodge(width = .85))+
