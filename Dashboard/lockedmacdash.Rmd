...
masterdata<-masterdata %>% mutate(Race = ifelse(Race == 1,"White or Caucasian",
                                                ifelse(Race == 2,"Black or African American",
                                                       ifelse(Race == 3,"Native American or Alaska Native",
                                                              ifelse(Race == 4,"Asian or Pacific Islander",
...
<img src="/Users/erteam/Desktop/Syndemic Project/syndemic/HomePage.png" width=600>

<!-- ![](/Users/erteam/Desktop/Syndemic Project/syndemic/HomePage.png) -->
...
eth<-masterdata %>% pull(Ethnicity) %>% unique() %>% sort()
...
renderPlotly(ggplotly(ggplot(df1(),
       aes(x = quarter,
           y = n,
           color = Age_Groups)) +
  geom_point() +
...
```{r}
  ...
  #Plots SUDS and SSTVI or Endo
renderPlotly(ggplotly(ggplot(data =md_phi_jacob %>% 
